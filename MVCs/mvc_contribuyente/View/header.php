...
<head>
    ...
    <link rel="stylesheet" href="assets/css/contribuyente.general.style.css">
    <link rel="stylesheet" href="assets/css/contribuyente.vista_general.style.css">
    <link rel="stylesheet" href="assets/css/contribuyente.nuevo-registro.main.style.css">
        ...
        $(document).ready(function(){
            $("#select-departamento").change(function(){
                ...
                $("#select-departamento option:selected").each(function () {
                    ...
                    $.post("mvc_contribuyente/includes/getMunicipio.php", {cod_departamento: cod_departamento}, function(data){
