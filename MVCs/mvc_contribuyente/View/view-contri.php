		...
		<table class="table table-bordered">
			<caption>
				<div class="vg-caption">
					...
					<a class="btn btn-primary" href="?c=Contribuyente&a=">Agregar Inmueble</a>
				</div>
			...
			<tbody>
				<?php foreach($this->model->ListarInmuebleContri($_REQUEST['correlativo']) as $r): ?>
					<tr>
						...
						<td>
							<a class="btn btn-info" href=""><i class="glyphicon glyphicon-list-alt"> Agregar servicios</i></a>
						</td>
						<td>
						...
						<td>
							...
							<?php
							include 'mvc_contribuyente/includes/modal.inmueble.php';
							?>
						</td>
					</tr>
				<?php $i++; endforeach; ?>
