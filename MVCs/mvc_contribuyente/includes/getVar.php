...
if($filas > 0){
	while ($rowResult = $sentencia->fetch()) {
		...
		$html .= "<td><center>";
		$html .= "<a class='enlace-tabla' href='?c=Contribuyente&a=View&id_contribuyente=".$rowResult['id_contribuyente']."&correlativo=".$rowResult['correlativo']."'>Vista general</a>";
		$html .= "</center></td>";
		$html .= "<td><i class='glyphicon glyphicon-edit'>";
		$html .= "<a href='?c=Contribuyente&a=Crud&id_contribuyente=".$rowResult['id_contribuyente']."&correlativo=".$rowResult['correlativo']."'>Editar</a>";
		$html .= "</i></td>";
		$html .= "<td><i class='glyphicon glyphicon-remove'>";
		$html .= "<a id='eliminar-dato-content-main-".$i."' href='#'>Eliminar</a>";
		$html .= "</i>";
