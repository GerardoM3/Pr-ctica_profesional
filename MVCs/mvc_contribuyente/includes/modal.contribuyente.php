        ...
        <div class="modal-eliminar" >
            ...
            <div class="cuerpo-modal">
                ...
                <div style="display:inline-flex;">
                    ...
                    <div class="result" style="color:black;"><u>$r->id_contribuyente-$r->correlativo</u></div>
                </div>
                <br>
                <div style="display:inline-flex;">
                    <div class="desc">Contribuyente: </div>
                    <div class="result" style="color:black;"><u>$r->nombre_contribuyente $r->apellido_contribuyente</u></div>
                </div>
            </div>
    ...
    <script>
        ...
        aceptar_eliminar_$i.addEventListener('click', ()=>{
                if(confirmar_$i.checked){
                    aceptar_eliminar_$i.setAttribute('href', `?c=Contribuyente&a=Eliminar&id_contribuyente=$r->id_contribuyente&correlativo=$r->correlativo`);
                    modal_eliminar_$i.style.display = "none";
                    aceptar_eliminar_$i.disabled = true;
                    confirmar_$i.checked = false;
                }
